				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown sign-up">
							<a class="dropdown-toggle btn-signup red-btn" data-toggle="dropdown" href=""> <?php
			                    foreach ($profile as $a) {
			                    ?>
								<img src="<?php echo base_url('assets/img/'.$a->foto) ?>" class="img-responsive img-circle" alt=""> <?php } ?><?php echo strtoupper($this->session->userdata('nama')); ?>
							</a>
