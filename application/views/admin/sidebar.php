    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="job">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('Admin/kandidataktif')?>">In Process</a></li>
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Accepted</a></li>
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Rejected</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
