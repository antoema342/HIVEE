<div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-xs-4">
                <h4>Perusahaan Aktif : <?php echo $perusahaanaktif?> </h4>
              </div>
              <div class="col-xs-1 col-xs-offset-2">
                <h4 class="tunggu-chart">&#9632</h4>
              </div>
              <div class="col-xs-4">
                <h4>Non Aktif : <?php echo $perusahaannonaktif?> </h4>
              </div>
            </div>
 ...
 <div class="col-xs-4 col-xs-offset-2">
          ...
          <div class="container">
            <div class="row">
                <div class="col-xs-12">
                  <h4 class="box-title ditolak-chart text-center">Perusahaan Aktif</h4>       
              ...
              <div class="row">
                <div class="col-xs-12">
                  <h4 class="box-title tunggu-chart text-center">Perusahaan Non Aktif</h4>       
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th>No</th>
