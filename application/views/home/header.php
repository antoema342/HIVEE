			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="br-right"><a href="<?php echo site_url('Login/loginperusahaan')?>"><i class="login-icon ti-user"></i>Login</a></li>
						<li class="sign-up"><a href="<?php echo site_url('register/register_perusahaan')?>" class="btn-signup red-btn" href="signup.html"><span class="ti-briefcase"></span>Create Account</a></li>
					</ul>
